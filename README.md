...
Latest: **v1.5.13** — see [CHANGELOG.md](CHANGELOG.md). Flatpak, AppImage, and Windows `.exe` on every [release](https://github.com/trevlars/Gamesphere-Import-Tool/releases/latest).
